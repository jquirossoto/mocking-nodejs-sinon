...
describe.skip('File Management Stub', () => {
    ...
    it('Should throw an excetion if file already exists', () => {
        const writeStub = sinon.stub(fs, 'writeFileSync');
    ...
    it('Should create a file name test1 if file test already exists', () => {
        const writeStub = sinon.stub(fs, 'writeFileSync');
    ...
    it('Should return a list of files - PROMISE', () => {
        const readStub = sinon.stub(fs, 'readdir');
        const util = {
